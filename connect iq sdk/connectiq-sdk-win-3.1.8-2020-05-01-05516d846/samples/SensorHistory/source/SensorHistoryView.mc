        ...
        if ( Toybox has :SensorHistory ) {
            ...
            if( sensorIter != null ) {
                ...
                if( gotValidData ) {
                    ...
                    dc.drawText(dc.getWidth()/2, 0, Graphics.FONT_SMALL, mSensorLabel[mIndex] + "\nMax: " + max + " Min: " + min, Graphics.TEXT_JUSTIFY_CENTER);
                    ...
                    dc.drawText(dc.getWidth()/2, dc.getHeight() - 40, Graphics.FONT_SMALL, "Start: " + startString + "\nEnd: " + endString, Graphics.TEXT_JUSTIFY_CENTER);
                }
                else {
